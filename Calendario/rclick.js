const attachContextMenu = (() => {
  ...
  document.querySelectorAll('div')
    .forEach(btn => {
        if (btn.className == 'contenedor') {
            attachContextMenu(btn, [
              {label: "Eventos", action(o) {console.log(o)},
                 subMenu: [
                   {label: 'Nuevo Evento', action(o) {console.log(o, btn.id, btn.className)}},
                   {label: "Borrar Evento", action(o) {console.log(o)}}
                 ]},
              {label: "Opciones", action(o) {console.log(o)},
                subMenu: [
                  {label: 'Ajustes', action(o) {console.log(o)}},
                  {label: 'Modo Oscuro', action(o) {console.log(o)}}
                ]
              }
            ]);
        }
